...
const userRoutes = require('./routes/users'); //Importation des router user message etc
...
app.use(bodyParser.json()); // le body-parser a analysé votre requête entrante, a assemblé les morceaux contenant vos données de formulaire, 
