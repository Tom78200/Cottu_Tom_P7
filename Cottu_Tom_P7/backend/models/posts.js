const mysql_con = require('../mysql_con'); // identifiants connexion a la db sql
...
class postsR {
    ...
    createPost(dataCreatePost) { //commande pour poster un message
    ...
    getAllPosts() { //commande pour récupérer les posts
    ...
    deletePost(reqPostId, reqPostIdUserId) { //commande pour supprimer son message
    ...
    createCom(reqPostComment) { //commande pour créer un commentaire
        let sqlCreateCom = "INSERT INTO `comments` (`userid`, `postid`, `text`, `createdate`, `name`) VALUES(?, ?, ?, NOW(), ?)"; //on reprend les élements de la bd
    ...
    getComments(reqGetCom) { //commande pour récupérer tout les commentaires
    ...
    deleteComment(reqDeleteCom) { //commande pour supprimer un commentaire
